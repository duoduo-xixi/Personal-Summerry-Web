...
const CONFIG = {
  name: "吴倩婷",                 // 你的名字 / 昵称
  initial: "吴",                 // 头像圆环里显示的字符（推荐用名字首字）
  brandName: "吴倩婷",               // 左上角 logo 文字
  ...
  desc: "桂林电子科技大学 · 计算机科学与技术（本科）。专注 AI 应用与全栈开发，把好奇心打磨成一个个能落地的产品。",
  email: "3113952602@qq.com",    // 你的邮箱
  birthday: "2004年4月5日",      // 生日
  phone: "17877219431",          // 联系电话
  facts: [
    { k: "院校", v: "桂林电子科技大学" },
    { k: "专业", v: "计算机科学与技术（本科）" },
    { k: "籍贯", v: "广西柳州" },
    { k: "外语", v: "大学英语四/六级" },
    { k: "荣誉", v: "英语六级 · 校级光电赛一等奖" },
  ],
  skills: [
  ...
  timeline: [
    { date: "2023.09 — 2027.07", role: "计算机科学与技术（本科）", org: "桂林电子科技大学", desc: "系统学习计算机基础与软件开发，持续探索 AI 应用与全栈工程实践。" },
    { date: "2026.04 — 2026.06", role: "AI 创客项目实习", org: "广东南方电信规划咨询设计院", desc: "基于 Tauri 2 + React 开发 CPMS Desktop，完成业务 API 逆向与自动化，并负责 AI 端到端平台测试。" },
    { date: "2026.06 — 2026.09", role: "AI Agent 全栈开发实习", org: "广州裴趣商贸有限公司", desc: "基于 Vue 3 / Electron 开发实时联机应用，封装 WebSocket 与 HTTP 层，并参与 RAG 智能客服官网开发。" },
  ],
  projects: [
  ...
  socials: [
    { name: "邮箱", icon: "&#9993;", href: "mailto:3113952602@qq.com" },
  ],
};
/* ========================================================= */
